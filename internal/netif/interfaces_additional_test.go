...
func TestGetPhysicalInterfaces(t *testing.T) {
	...
	interfaces["other0"] = &netif.InterfaceInfo{
		Name:      "other0",
...
func TestSelectBestPriority(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			candidates := netif.CreateInterfaceCandidates(
				tt.ethernetWithIP,
				tt.wifiWithIP,
				tt.ethernetUp,
				tt.wifiUp,
...
func TestCollectCandidatesWithOtherType(t *testing.T) {
	...
	interfaces["unknown0"] = &netif.InterfaceInfo{
		Name:      "unknown0",
		Type:      netif.InterfaceTypeOther,
		Up:        true,
		Addresses: []string{"192.168.1.100/24"},
...
func TestDetectInterfaceTypeEdgeCases(t *testing.T) {
	tests := []struct {
		...
		{"loopback lo1", "lo1", netif.InterfaceTypeLoopback},
		{"loopback lo9", "lo9", netif.InterfaceTypeLoopback},
		{"not loopback lo10", "lo10", netif.InterfaceTypeOther},
		{"not loopback local", "local", netif.InterfaceTypeOther},
		{"not loopback long", "long", netif.InterfaceTypeOther},

		// Virtual interface variants
		{"vnet", "vnet0", netif.InterfaceTypeVirtual},
		{"vmnet", "vmnet1", netif.InterfaceTypeVirtual},
		{"vboxnet", "vboxnet0", netif.InterfaceTypeVirtual},
		{"utun", "utun0", netif.InterfaceTypeVirtual},

		// WiFi interface variants
		{"ra wifi", "ra0", netif.InterfaceTypeWiFi},
		{"wl wifi", "wl0", netif.InterfaceTypeWiFi},

		// Edge case: empty name
		{"empty name", "", netif.InterfaceTypeOther},
	}
...
func TestValidNetmaskDottedDecimal(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run("netmask_"+tt.mask, func(t *testing.T) {
			got := netif.IsValidNetmask(tt.mask)
			if got != tt.want {
...
func TestLinkStatusWithRunningInterface(t *testing.T) {
	...
	var runningIface *netif.InterfaceInfo
...
func TestGetLinkStatusWithMockInterface(t *testing.T) {
	...
	interfaces["mock0"] = &netif.InterfaceInfo{
		Name:      "mock0",
		Type:      netif.InterfaceTypeEthernet,
		Up:        true,
		Running:   true,
