...
func TestSchedulerService_Create_TableDriven(t *testing.T) {
	...
	tests := []struct {
		...
		wantErr   bool
		errSubstr string
		validate  func(t *testing.T, sr *reporting.ScheduledReport)
	}{
		{
		...
		},
		{
			...
			validate: func(t *testing.T, sr *reporting.ScheduledReport) {
				...
				assert.Equal(t, reporting.FrequencyWeekly, sr.Schedule.Frequency)
			},
		},
		{
...
func TestSchedulerService_Get_TableDriven(t *testing.T) {
	...
	existingSchedule := &reporting.ScheduledReport{
...
func TestSchedulerService_Update_TableDriven(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			name: "update format",
			modifyFn: func() *reporting.ScheduledReport {
				schedule.Format = reporting.FormatHTML
				return schedule
			},
			wantErr: false,
			validate: func(t *testing.T, sr *reporting.ScheduledReport) {
				result, _ := ss.Get(ctx, sr.ID)
				assert.Equal(t, reporting.FormatHTML, result.Format)
			},
		},
		{
			name: "change to weekly frequency",
			modifyFn: func() *reporting.ScheduledReport {
				schedule.Schedule.Frequency = reporting.FrequencyWeekly
			...
			validate: func(t *testing.T, sr *reporting.ScheduledReport) {
				result, _ := ss.Get(ctx, sr.ID)
				assert.Equal(t, reporting.FrequencyWeekly, result.Schedule.Frequency)
...
func TestScheduledReport_AllTemplatesAndFormats(t *testing.T) {
	...
	formats := []reporting.ExportFormat{
		reporting.FormatPDF,
...
func TestScheduleFrequency_Constants(t *testing.T) {
	tests := []struct {
		name     string
		freq     reporting.ScheduleFrequency
		expected string
	}{
		{name: "daily", freq: reporting.FrequencyDaily, expected: "daily"},
		{name: "weekly", freq: reporting.FrequencyWeekly, expected: "weekly"},
		{name: "monthly", freq: reporting.FrequencyMonthly, expected: "monthly"},
	}
...
func TestExportFormat_Constants(t *testing.T) {
	tests := []struct {
		...
		{name: "PDF", format: reporting.FormatPDF, expected: "pdf"},
		{name: "HTML", format: reporting.FormatHTML, expected: "html"},
		{name: "CSV", format: reporting.FormatCSV, expected: "csv"},
		{name: "JSON", format: reporting.FormatJSON, expected: "json"},
		{name: "Excel", format: reporting.FormatExcel, expected: "xlsx"},
		{name: "Markdown", format: reporting.FormatMarkdown, expected: "md"},
	}
