...
func processSampleData(rawData any, surveyID string, logger *slog.Logger) any {
	...
	if _, hasNetworks := dataMap["networks"]; hasNetworks {
		return processPassiveSample(dataMap, surveyID, logger)
	}

	if _, hasBSSID := dataMap["bssid"]; hasBSSID {
		return processActiveSample(dataMap, surveyID, logger)
	}
...
func processPassiveSample(dataMap map[string]any, surveyID string, logger *slog.Logger) any {
...
func processActiveSample(dataMap map[string]any, surveyID string, logger *slog.Logger) any {
