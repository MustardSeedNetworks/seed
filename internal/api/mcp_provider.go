...
// networkManagerAdapter adapts netif.Manager to the mcp.NetworkManager interface.
type networkManagerAdapter struct {
	mgr *netif.Manager
}

func (a *networkManagerAdapter) GetInterfaces() []*netif.InterfaceInfo {
	return a.mgr.GetInterfaces()
}

func (a *networkManagerAdapter) GetInterface(name string) (*netif.InterfaceInfo, error) {
...
// linkMonitorAdapter adapts netif.LinkMonitor to the mcp.LinkMonitor interface.
type linkMonitorAdapter struct {
	mon *netif.LinkMonitor
}

func (a *linkMonitorAdapter) GetState() netif.LinkState {
