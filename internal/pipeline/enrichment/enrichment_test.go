...
// as EnrichmentService. See internal/pipeline/services.go for the implementation
// and internal/pipeline/services_test.go for comprehensive tests.
func TestPackageExists(t *testing.T) {
	...
	//
	// The following functionality is tested in internal/pipeline/services_test.go:
...
func TestEnrichmentPackageDocumentation(t *testing.T) {
	...
	//
	// Current implementation location: internal/pipeline/services.go (EnrichmentService)
}
