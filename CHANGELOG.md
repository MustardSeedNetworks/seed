...
* **e2e:** derive the Playwright guard version from the container image ([#2734](https://github.com/MustardSeedNetworks/seed/issues/2734)) ([492bde6](https://github.com/MustardSeedNetworks/seed/commit/492bde62efa5539c07a9ba2e523201c5384afeac))
...
* **auth-ui:** stop the login screen claiming an expiry that never happened ([#2717](https://github.com/MustardSeedNetworks/seed/issues/2717)) ([cdbee2d](https://github.com/MustardSeedNetworks/seed/commit/cdbee2dfa04777397149848b76847f120b5bff58))
* **auth:** stop the CSRF token endpoint invalidating the session's other tabs ([#2718](https://github.com/MustardSeedNetworks/seed/issues/2718)) ([f4ea68e](https://github.com/MustardSeedNetworks/seed/commit/f4ea68e756b11046742a7437961da9f292deaa78))
...
* **ci:** the release contract pins version SHAPE, not literal values ([#2653](https://github.com/MustardSeedNetworks/seed/issues/2653)) ([10407a8](https://github.com/MustardSeedNetworks/seed/commit/10407a8197a80be2270e5f0ec9bfd77d802642d1)), closes [#2622](https://github.com/MustardSeedNetworks/seed/issues/2622)
...
* **deps:** update dependency @rolldown/plugin-babel to v0.2.4 ([#2594](https://github.com/MustardSeedNetworks/seed/issues/2594)) ([283baec](https://github.com/MustardSeedNetworks/seed/commit/283baecffc5e8d2a1949566546bb481d9a181b54))
...
* **deps:** lock file maintenance ([#2562](https://github.com/MustardSeedNetworks/seed/issues/2562)) ([522d125](https://github.com/MustardSeedNetworks/seed/commit/522d1253c770124c702212e5c1f42540ba194ca6))
...
* **discovery:** resolve SNMP credentials from the vault, scoped to one client ([#2546](https://github.com/MustardSeedNetworks/seed/issues/2546)) ([74e5f82](https://github.com/MustardSeedNetworks/seed/commit/74e5f8280471c56065f7c8de834dc83f66d6e225))

## [0.214.31](https://github.com/MustardSeedNetworks/seed/compare/v0.214.30...v0.214.31) (2026-09-09)


### Miscellaneous

* **deps:** lock file maintenance ([#2544](https://github.com/MustardSeedNetworks/seed/issues/2544)) ([27e41df](https://github.com/MustardSeedNetworks/seed/commit/27e41dfde7f35b62ef7654fc37314c89e936cce0))

## [0.214.30](https://github.com/MustardSeedNetworks/seed/compare/v0.214.29...v0.214.30) (2026-09-09)


### Bug Fixes

* **discovery:** an unresolved IPv6 neighbour is not a device ([#2540](https://github.com/MustardSeedNetworks/seed/issues/2540)) ([5c65581](https://github.com/MustardSeedNetworks/seed/commit/5c6558191e569e05694594f2a25574a9daa8beed)), closes [#2337](https://github.com/MustardSeedNetworks/seed/issues/2337)

## [0.214.29](https://github.com/MustardSeedNetworks/seed/compare/v0.214.28...v0.214.29) (2026-09-08)


### Miscellaneous

* **deps:** lock file maintenance ([#2537](https://github.com/MustardSeedNetworks/seed/issues/2537)) ([bf44ab4](https://github.com/MustardSeedNetworks/seed/commit/bf44ab47684838cbfc64ff8c594bdb9f3808fcdd))

## [0.214.28](https://github.com/MustardSeedNetworks/seed/compare/v0.214.27...v0.214.28) (2026-09-08)


### Bug Fixes

* **ui:** read the wire, not a hand-typed mirror of it ([#2532](https://github.com/MustardSeedNetworks/seed/issues/2532)) ([56eb3c4](https://github.com/MustardSeedNetworks/seed/commit/56eb3c438a8a769652df7ea04aa12840dea4889a))
...
* **e2e:** keep the failing attempt's trace in auth-complete ([#2519](https://github.com/MustardSeedNetworks/seed/issues/2519)) ([eb8dcc9](https://github.com/MustardSeedNetworks/seed/commit/eb8dcc9705007f0d2cf8591ea614202bc990e1ee))

## [0.214.25](https://github.com/MustardSeedNetworks/seed/compare/v0.214.24...v0.214.25) (2026-09-08)


### Bug Fixes

* **deps:** update go dependencies ([#2516](https://github.com/MustardSeedNetworks/seed/issues/2516)) ([7227453](https://github.com/MustardSeedNetworks/seed/commit/7227453b377bef5248543226bac4ad3b597718a1))
...
* **deps:** update mustardseednetworks/.github action to v1.12.0 ([#2498](https://github.com/MustardSeedNetworks/seed/issues/2498)) ([e2845c4](https://github.com/MustardSeedNetworks/seed/commit/e2845c4b57a7b946332921b801c984ffa8f3b587))
...
* **deps:** lock file maintenance ([#2488](https://github.com/MustardSeedNetworks/seed/issues/2488)) ([50de8bb](https://github.com/MustardSeedNetworks/seed/commit/50de8bb744b3a9dfc06f67399268ff1e5eb0b84a))

## [0.214.17](https://github.com/MustardSeedNetworks/seed/compare/v0.214.16...v0.214.17) (2026-09-07)


### Bug Fixes

* **ui:** give a viewer the settings drawer read-only, not a notice ([#2487](https://github.com/MustardSeedNetworks/seed/issues/2487)) ([57271b4](https://github.com/MustardSeedNetworks/seed/commit/57271b4d1c3bd988aec0079412cafca787df64bc))

## [0.214.16](https://github.com/MustardSeedNetworks/seed/compare/v0.214.15...v0.214.16) (2026-09-07)


### Miscellaneous

* **deps:** lock file maintenance ([#2485](https://github.com/MustardSeedNetworks/seed/issues/2485)) ([67d3520](https://github.com/MustardSeedNetworks/seed/commit/67d3520a97cb0b087e58152272944685e6ef3bcd))

## [0.214.15](https://github.com/MustardSeedNetworks/seed/compare/v0.214.14...v0.214.15) (2026-09-07)


### Code Refactoring

* **ui:** split the last two settings files off the size baseline ([#2483](https://github.com/MustardSeedNetworks/seed/issues/2483)) ([8eb6faf](https://github.com/MustardSeedNetworks/seed/commit/8eb6faf9cabcd3d00405c634be13fe11d7f7be27)), closes [#2467](https://github.com/MustardSeedNetworks/seed/issues/2467)

## [0.214.14](https://github.com/MustardSeedNetworks/seed/compare/v0.214.13...v0.214.14) (2026-09-07)


### Miscellaneous

* **deps:** lock file maintenance ([#2480](https://github.com/MustardSeedNetworks/seed/issues/2480)) ([915e180](https://github.com/MustardSeedNetworks/seed/commit/915e180557fff6aff744c8457a3a1b77289d920d))
* **deps:** lock file maintenance ([#2482](https://github.com/MustardSeedNetworks/seed/issues/2482)) ([9db294a](https://github.com/MustardSeedNetworks/seed/commit/9db294a7f6dd12b5ae67053642c930dd8e0c8098))

## [0.214.13](https://github.com/MustardSeedNetworks/seed/compare/v0.214.12...v0.214.13) (2026-09-07)


### Miscellaneous

* **deps:** lock file maintenance ([#2477](https://github.com/MustardSeedNetworks/seed/issues/2477)) ([bcd703b](https://github.com/MustardSeedNetworks/seed/commit/bcd703b30ca53f3d8dfa8b543740605806c2d728))

## [0.214.12](https://github.com/MustardSeedNetworks/seed/compare/v0.214.11...v0.214.12) (2026-09-07)


### Bug Fixes

* **ui:** gate the three settings sections that had to shrink first ([#2467](https://github.com/MustardSeedNetworks/seed/issues/2467)) ([#2473](https://github.com/MustardSeedNetworks/seed/issues/2473)) ([8af434b](https://github.com/MustardSeedNetworks/seed/commit/8af434b36f6b3783ab0c8b81dc324831f8f9930a))

## [0.214.11](https://github.com/MustardSeedNetworks/seed/compare/v0.214.10...v0.214.11) (2026-09-07)


### Bug Fixes

* **snmp:** reload the poller when polling targets change through the API ([#2461](https://github.com/MustardSeedNetworks/seed/issues/2461)) ([2e7c33d](https://github.com/MustardSeedNetworks/seed/commit/2e7c33d2a011dd281f666f7fa4fd7d7190b860ed))

## [0.214.10](https://github.com/MustardSeedNetworks/seed/compare/v0.214.9...v0.214.10) (2026-09-07)


### Bug Fixes

* **ui:** gate the settings sections that also carry a read ([#2467](https://github.com/MustardSeedNetworks/seed/issues/2467)) ([#2470](https://github.com/MustardSeedNetworks/seed/issues/2470)) ([cbf7b79](https://github.com/MustardSeedNetworks/seed/commit/cbf7b79a54f5a2aaae715fae9104e001fcf54c77))

## [0.214.9](https://github.com/MustardSeedNetworks/seed/compare/v0.214.8...v0.214.9) (2026-09-07)


### Bug Fixes

* **ui:** let a viewer read the settings sections without mutating them ([#2468](https://github.com/MustardSeedNetworks/seed/issues/2468)) ([6de3c78](https://github.com/MustardSeedNetworks/seed/commit/6de3c784e93ed43009bc0f2f5eeb7ec5f12cba74)), closes [#2467](https://github.com/MustardSeedNetworks/seed/issues/2467)
